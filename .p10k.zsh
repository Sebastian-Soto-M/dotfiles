# Generated by Powerlevel10k configuration wizard on 2020-07-25 at 18:24 MDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 38309.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# slanted separators, slanted heads, sharp tails, 2 lines, solid, full frame,
# lightest-ornaments, sparse, many icons, concise, transient_prompt, instant_prompt=off.
