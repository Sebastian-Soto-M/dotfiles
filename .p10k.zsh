# Generated by Powerlevel10k configuration wizard on 2020-08-11 at 18:29 MDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 41327.
...
() {
  ...
  #typeset -g POWERLEVEL9K_TIMEWARRIOR_CONTENT_EXPANSION='${P9K_CONTENT:0:35}${${P9K_CONTENT:35}:+…}'
  ...
  ##############[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]##############
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=14
