# Generated by Powerlevel10k configuration wizard on 2020-09-07 at 07:47 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 46546.
# Wizard options: powerline, unicode, lean_8colors, 12h time, 2 lines, disconnected,
# no frame, compact, concise, transient_prompt, instant_prompt=quiet.
